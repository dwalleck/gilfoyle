...
- **Record reconciliation:** every figure, count, and head label re-anchored to the post-repair revision or marked superseded; every claim of performed verification names the receipt and the revision that performed it.
