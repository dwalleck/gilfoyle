...
Read `skills/gilfoyle/references/falsifiable-design.md` and `skills/gilfoyle/references/checkpointed-build.md`, then independently rebuild and run every accepted oracle, falsifier, and regression fence against the assembled binary. Reconcile receipts and lifecycle IDs; never trust worker prose.
